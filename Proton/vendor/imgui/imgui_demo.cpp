...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Basic"))
    {
...

        {
            ...
            ImGui::InputFloat3("input DirectX::XMFLOAT3", vec4a);
        }
    ...
    if (ImGui::TreeNode("Multi-component Widgets"))
    {
        ...
        ImGui::InputFloat3("input DirectX::XMFLOAT3", vec4f);
        ImGui::DragFloat3("drag DirectX::XMFLOAT3", vec4f, 0.01f, 0.0f, 1.0f);
        ImGui::SliderFloat3("slider DirectX::XMFLOAT3", vec4f, 0.0f, 1.0f);
